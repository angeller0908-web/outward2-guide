...
const allGuides: Guide[] = [
  ...
  },
  {
    ...
    description: 'Detailed breakdown of all three starting scenarios — biomes, opening quests, and early gameplay differences. Includes a full guide to the 11 backgrounds and 10 traits.',
    category: 'beginner',
  ...
  },
  {
    ...
    description: 'Can your PC run Outward 2? Full spec analysis plus optimization tips for the unique Potato Mode that lets lower-end systems join the adventure. Updated after the Early Access delay to 2027.',
    category: 'beginner',
    tags: ['PC', 'Performance'],
    icon: '💻',
    readTime: 7,
  ...
  },
  {
    ...
    description: 'Every confirmed defeat outcome from the beta — from kind travelers to robbery and abandonment. How the fracture system works, why resting won\'t save you, and what to carry to recover.',
    category: 'survival',
