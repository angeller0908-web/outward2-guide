...
export const guides: GuideArticle[] = [
  ...
  },
  {
    ...
    description:
      "Outward 2 doesn't have a game-over screen. When you fall, the game continues — but the consequences vary wildly. This guide covers every confirmed defeat scenario from the beta and how to recover from each one, including the injury and fracture system.",
    category: 'survival',
    tags: ['death', 'defeat', 'fractures', 'injury', 'consequences', 'recovery', 'mechanics'],
    author: 'Loremaster Theron',
    date: '2026-06-17',
    readTime: 8,
    featured: false,
